...
## Графики для моего задания

### Режим fuel (экономия топлива)
Время: 256.588 с, Расход: 659.929 кг

![Графики fuel](trajectory_plots_fuel.png)

### Режим time (быстрый полёт)
Время: 256.539 с, Расход: 659.975 кг

![Графики time](trajectory_plots_time.png)
